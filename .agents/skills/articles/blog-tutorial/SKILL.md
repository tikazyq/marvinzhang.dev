...
For a deep tutorial, AI scaffolds the draft workspace, then gathers input through conversation:
...
AI asks questions from the conversation guide 1-2 at a time — covering learning objectives, prerequisites, steps, pitfalls, and success criteria. Author answers in chat. AI writes everything to the draft workspace.
