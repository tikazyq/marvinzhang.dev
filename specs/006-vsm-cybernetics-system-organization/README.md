...
> **Status**: planned · **Priority**: medium · **Created**: 2026-05-12 · **Style**: 🔬 Analytical
...
- The default `spec-template.md` was generated by `lean-spec create` instead of the analytical template (`lean-spec` 0.2.28). The analytical-template fields live in `research.md` / `outline.md` per the author's chosen layout (Option B).
