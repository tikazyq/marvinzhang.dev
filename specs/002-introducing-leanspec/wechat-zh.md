...
> 刚接触 SDD？可以先阅读我的基础文章 [规格驱动开发：复杂功能的系统化方法](https://marvinzhang.dev/zh/blog/spec-driven-development) 了解方法论基础，或者看 [2025 年 SDD 工具全景](https://marvinzhang.dev/zh/blog/sdd-tools-practices) 了解业界工具的全面对比。想不安装任何工具就体验方法论？试试 [不用工具实践 SDD](https://www.lean-spec.dev/docs/tutorials/sdd-without-toolkit) 教程。
...
![](https://marvinzhang.dev/img/blog/2025-11-27-introducing-leanspec/wechat/diagram-zh-1.png)
...
如果你读过我的 [SDD 工具分析](https://marvinzhang.dev/zh/blog/sdd-tools-practices)，就知道我评估过这个领域的六个主要工具。LeanSpec 的定位是这样的：
...
📝 **本文同步发布于我的个人技术博客** [marvinzhang.dev](https://marvinzhang.dev/zh/blog/introducing-leanspec)

🔗 **完整文章链接：** https://marvinzhang.dev/zh/blog/introducing-leanspec
