---
title: OpenAI Function Call API in Langchain Library
date: 2023/10/18
description: While exploring the field of artificial intelligence, we often need to leverage existing APIs to implement specific f...
tag: ai
author: Marvin Zhang
---
