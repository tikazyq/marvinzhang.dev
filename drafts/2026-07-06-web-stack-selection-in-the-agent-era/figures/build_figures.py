...
F5 = {
 "en": dict(
  ...
  subtitle="Qualitative placements, not scores — some languages are shown for reference without full treatment in the body. Reliability and ecosystem maturity remain entry tickets outside both axes.",
  ...
  pts=[
   ("PHP", 0.66, 0.42, "#e65100", "right"),
   ("Ruby", 0.75, 0.22, "#c62828", "bottom"),
   ("Kotlin", 0.38, 0.68, "#7b1fa2", "top"),
   ("Rust", 0.20, 0.88, "#01579b", "right"),
   ("Java", 0.40, 0.58, "#01579b", "bottom"),
   ("C#", 0.55, 0.70, "#2e7d32", "top"),
   ("C/C++", 0.16, 0.35, "#c62828", "right"),
 ...
 "zh": dict(
  ...
  h1="循环延迟 × 验证信号密度",
  subtitle="各点位置为定性判断而非打分；部分语言正文未展开，仅供参照。可靠性与生态成熟度是两轴之外的入场券。",
