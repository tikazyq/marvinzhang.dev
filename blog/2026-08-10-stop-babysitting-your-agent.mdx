...
But the reason it loops may not be the one you assume. It isn't mostly about being smart. **What matters is that every time around, it gets an answer that didn't come from itself.**
...
## Three things you can do, and one I haven't run

Back to the title: how do you stop babysitting an agent.

Three you can do today:
...
Push the argument one step further and a fourth appears: separate the checking side from the doing side, keep them independent, have them communicate only through artifacts (code, logs, test results), and put the conditions themselves out of reach of both. Other industries have done this forever — financial review, two-person sign-off before a release. This is just moving it onto agents.

**But I'll be straight about this one: I haven't run it.** Last time I left a gap that was an unmeasured multiple; this time the gap is an untested arrangement. Naming the hole is more honest than serving up a design I haven't tried.
