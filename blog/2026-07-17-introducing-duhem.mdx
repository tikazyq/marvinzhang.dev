...
We're looking for a small number of engineering owners building such systems with AI, to shape Duhem with us: you get direct support and a direct line to the people building it; we get the test of real-world use. Interested → **`TODO(maintainer): design-partner contact link`**
