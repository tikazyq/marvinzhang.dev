...
title: "Cybernetics and AI Agents: A Forgotten Old Language"
authors: ["marvin"]
...
![The Viable System Model with algedonic channel — five levels mapped against a traditional engineering team and an AI agent pipeline, with S3* as a parallel side channel and the algedonic alarm path bypassing S2, S3 and S4](/img/blog/2026-05-12-vsm-cybernetics-system-organization/figure-2-vsm.en.png)
...
![Three life-grounded examples — body composition, financial freedom, experience — each shown twice: a single useful number on one side, the richer structure the number compresses on the other](/img/blog/2026-05-12-vsm-cybernetics-system-organization/figure-3-compression.en.png)
...
![Three engineering rules — coverage threshold, p99 latency SLO, two-reviewer requirement — each shown with the rule, the optimisation engineers actually perform, and the result that ships](/img/blog/2026-05-12-vsm-cybernetics-system-organization/figure-4-goodhart.en.png)

*Figure 4: A rule is set in good faith (top of each card). Engineers optimise for the rule (left). What ships is a green metric and an unchanged underlying problem (right). The pattern is structurally guaranteed once a projection becomes a target — a [well-documented phenomenon](https://jellyfish.co/blog/goodharts-law-in-software-engineering-and-how-to-avoid-gaming-your-metrics/) the industry has been working through for years.*
