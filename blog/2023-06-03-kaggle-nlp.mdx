---
slug: kaggle-nlp
title: '实战数据科学: 如何利用 sklearn 轻松上榜 Kaggle 入门 NLP 竞赛 (English Translation Needed)'
authors:
  - marvin
tags:
  - ai
...
**Chinese Title:** 实战数据科学: 如何利用 sklearn 轻松上榜 Kaggle 入门 NLP 竞赛

**Original Publication Date:** 2023-06-03
